...
def calcular_salario_liquido(valor_hora: float, horas_trabalhadas: int):
    ...
    descontos_parciais = inss + sindicato
    if salario_bruto <= 900:
        ir = 0
        descontos_totais = descontos_parciais + ir
